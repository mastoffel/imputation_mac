...
sink("main_files_cv/AlphaImputeSpec.txt")
...
cat("CoreAndTailLengths                  ,200,300,400,500,600",                                  "\n")
cat("CoreLengths                         ,150,250,350,450,550",                                  "\n")
cat("PedigreeFreePhasing                 ,No",                                               "\n")
cat("GenotypeError                       ,0.5",                                              "\n")
#cat("LargeDatasets                       ,No",                                               "\n")
cat("AlphaPhaseOutput                    ,Yes",                                              "\n")
cat("= BOX 6: Imputation =================================================================",  "\n")
cat("InternalIterations                  ,3",                                                "\n")
